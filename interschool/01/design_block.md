...
Строго говоря, как угодно - при большом желании это можно делать ручкой на бумаге. 

Тем не менее, лучше всего пользоваться инструментами специально для этого. Один из таких - draw.io. Описание того, как им пользоваться (с картинками), тут: TODO

#### А что такое блок-схема?
Это способ описания того, как будет работать код, при помощи диаграмм. У них есть специальная нотация, про которую можно почитать тут: TODO
